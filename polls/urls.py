...
urlpatterns = [
    ...
    path("<slug:comp_slug>/load_users/", views.load_users, name="load_users"),
    path("<slug:comp_slug>/profile/", views.user_profile, name="create_user"),
    path("<slug:comp_slug>/profile/<int:usr_id>", views.user_profile, name="user_profile"),
    path("<slug:comp_slug>/change_password/", views.change_password, name="change_password"),
    # path("<slug:comp_slug>/administration/", views.admin_polls, name="admin_polls"),
    path("<slug:comp_slug>/admin_events/", views.admin_events, name="admin_events"),
    path("<slug:comp_slug>/admin_users/", views.admin_users, name="admin_users"),
    path("<slug:comp_slug>/admin_groups/", views.admin_groups, name="admin_groups"),
    # path("<slug:comp_slug>/administration/<int:admin_id>", views.admin_polls, name="admin_polls"),
    # path("<slug:comp_slug>/administration/<int:admin_id>/<int:elt_id>", views.admin_polls, name="admin_polls"),
    path("<slug:comp_slug>/delete_user/<int:usr_id>", views.delete_user, name="delete_user"),
